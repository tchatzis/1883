...
const Content = function()
{
    ...
    const templates =
    {
        ...
        event: ( params ) =>
        {
            ...
            new widgets.Drilldown( { element: div, config:
            [ 
        ...
        schema: function( params )
        {
            ...
            var object = 
            {
                ...
                widgets:
                [
                    { class: "Select", params: { array: [ "", "table", "calendar" ], name: "content" } },
                    { class: "Select", params: { array: [ "", "label", "sequence" ], name: "sub" } },
                    { class: "Array", params: { element: div, name: "fields", widgets: [ { class: "Input", params: { type: "text", name: "field", required: true, headless: true } } ] } },
                    { class: "Input", params: { type: "text", name: "sort" } },
                    { class: "Input", params: { type: "text", name: "tab" } }
                ]
            };

            new widgets.Input( { type: "input", Form: id, name: "label", value: values[ "label" ], element: div } );
            new widgets.Input( { type: "input", Form: id, name: "endpoint", required: true, value: values[ "endpoint" ], element: div } );
            ...
            new widgets.Select( { Form: id, name: "class", required: true, value: values[ "class" ], array: [ "DB", "Static", "Download", "File", "Directory" ], element: div } );
            new widgets.Select( { Form: id, name: "role", required: true, value: values[ "role" ], array: [ "public", "user", "admin", "developer" ], element: div } );
            new widgets.Object( object );
            //new widgets.Tuple( { name: "parameters", element: div, values: values } );
        },
        sequence: ( params ) =>
        {
            var { id, values, div } = includes[ params.action ]( params );
        ...
        { 
            ...
            var matrix = 
            {
                ...
                [
                    ...
                    { class: "Input", params: { name: "inventory", field: "quantity", type: "number", min: 0 } }
                ]
            };
            ...
            new widgets.Input( { type: "input", Form: id, name: "label", required: true, value: values[ "label" ], element: div } );
            new widgets.Input( { type: "input", Form: id, name: "description", required: false, value: values[ "description" ], element: div } );
            new widgets.Drilldown( { element: div, config: 
            [ 
        ...
        test: function( params )
        {
            ...
            var matrix = 
            {
                ...
                widgets:
                [
                    { class: "Select", params: { name: "rooms", field: "label" } },
                    { class: "Select", params: { name: "storage", field: "label" } }
                ]
            };
        ...
        todo: function( params )
        {
            ...
            new widgets.Date( { Form: id, name: "date", required: true, value: values[ "date" ], element: div } );
            new widgets.Input( { type: "input", Form: id, name: "type", required: true, value: values[ "type" ], element: div } );
            new widgets.Input( { type: "input", Form: id, name: "label", required: true, value: values[ "label" ], element: div } );
            new widgets.Input( { type: "input", Form: id, name: "script", value: values[ "script" ], element: div } );
            new widgets.Input( { type: "number", Form: id, name: "line", required: true, value: values[ "line" ], element: div, size: 2, min: 0 } );
            new widgets.Text( { Form: id, name: "description", value: values[ "description" ], element: div } );
            new widgets.Date( { Form: id, name: "completed", value: values[ "completed" ], element: div } );
        },
